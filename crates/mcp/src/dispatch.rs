...
impl McpServer {
    pub(crate) async fn apply_offer_bind(
        ...
        let result = match offer_id {
            ...
            "sandbox.jail" => self.offers.sandbox_jail.bind(binding_id, policy).await,
            ...
            "tools.registry" => self.offers.tools_registry.bind(binding_id, policy).await,
            "tools.loop" => self.offers.tools_loop.bind(binding_id, policy).await,
            ...
            "browser.session" => self.offers.browser.bind(binding_id, policy).await,
    ...
    pub(crate) async fn apply_offer_unbind(
        ...
        match offer_id {
            ...
            "sandbox.jail" => self.offers.sandbox_jail.unbind(binding_id).await,
            ...
            "tools.registry" => self.offers.tools_registry.unbind(binding_id).await,
            "tools.loop" => self.offers.tools_loop.unbind(binding_id).await,
            ...
            "browser.session" => self.offers.browser.unbind(binding_id).await,
    ...
    pub(crate) async fn dispatch_invoke(
        ...
        let resp = match offer_id.as_str() {
            ...
            "sandbox.jail" => dispatcher.invoke(&self.offers.sandbox_jail, req).await,
            ...
            "tools.registry" => dispatcher.invoke(&self.offers.tools_registry, req).await,
            "tools.loop" => dispatcher.invoke(&self.offers.tools_loop, req).await,
            ...
            "browser.session" => dispatcher.invoke(&self.offers.browser, req).await,
